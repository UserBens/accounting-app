                        ...
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <select name="type" class="form-control" required>
                                    ...
                                    <option {{ $selectedType === 'place_birth' ? 'selected' : '' }} value="place_birth">
                                        Place Birth</option>
                                </select>
                        ...
                        <div class="col-2">
                            <div class="form-group">
                                ...
                                <select name="grade_id" class="form-control text-center">
                                    ...
                                    <option value="all" {{ $selectedGrade === 'all' ? 'selected' : '' }}>-- All Grades --
                                    </option>

                                    @foreach ($grades as $grade)
                                        <option value="{{ $grade->id }}"
                                            {{ $selectedGrade == $grade->id ? 'selected' : '' }}>
                                            {{ $grade->name . ' - ' . $grade->class }}</option>
                                    @endforeach
                        ...
                        <div class="col-2">
                            <div class="form-group">
                                ...
                                <select name="sort" class="form-control">
                                    <option value="desc" {{ $selectedSort === 'desc' ? 'selected' : '' }}>Descending
                                    </option>
                                    <option value="asc" {{ $selectedSort === 'asc' ? 'selected' : '' }}>Ascending
                                    </option>
                                </select>
                            </div>
                        </div>
                        <div class="col-2">
                            <div class="form-group">
                                ...
                                <select name="order" class="form-control">
                                    <option {{ $selectedOrder === 'created_at' ? 'selected' : '' }} value="created_at">
                                        Register</option>
                                    <option {{ $selectedOrder === 'name' ? 'selected' : '' }} value="name">Name</option>
                                    <option {{ $selectedOrder === 'grade_id' ? 'selected' : '' }} value="grade_id">Grade
                                    </option>
                                    <option {{ $selectedOrder === 'gender' ? 'selected' : '' }} value="gender">Gender
                                    </option>
                                    <option {{ $selectedOrder === 'place_birth' ? 'selected' : '' }} value="place_birth">
                                        Place Birth</option>
                                    <option {{ $selectedOrder === 'status' ? 'selected' : '' }} value="status">Status
                                    </option>
                                </select>
                        ...
                        <div class="col-2">
                            <div class="form-group">
                                ...
                                <select name="status" class="form-control">
                                    ...
                                    <option {{ $selectedStatus === 'inactive' ? 'selected' : '' }} value="inactive">
                                        Inactive</option>
                                    <option {{ $selectedStatus === 'graduate' ? 'selected' : '' }} value="graduate">
                                        Graduate</option>
                                </select>
                            </div>
                        </div>
